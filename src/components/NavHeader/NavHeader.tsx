      ...
      {isAuthenticated && <Popover renderPopover={
        <div className='bg-white relative shadow-md rounded-sm border border-gray-200'>
          <Link to={path.profile}
                className='block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500 text-left w-full'>Tài khoản
            của tôi</Link>
          <Link to='/' className='block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500 text-left w-full'>Đơn
            mua</Link>
          <button onClick={handleLogout}
                  className='block py-3 px-4 hover:bg-slate-100 bg-white hover:text-cyan-500 text-left w-full'>Đăng xuất
          </button>
        </div>
